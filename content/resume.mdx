...
Versatile front-end developer/designer with 9+ years of experience designing and developing SaaS web app. Passionate in design system, crafted in-house UI component library. Always build user interface considering the best user experience and up to date with the latest front-end technologies.
...
- Develop an UI component library
